...
const Dashboard = () => {
  ...
  const fetchAcceptMessage = useCallback(async () => {
    ...
    try {
      ...
      toast({
        title: "Error",
        description: axiosError.response?.data.message || "Failed to fetch message settngs",
        variant: "destructive"
      })
    } finally {
  ...
  const handleSwitchChange = async () => {
    try {
      ...
      toast({
        title: "Error",
        description: axiosError.response?.data.message || "Failed to change message settngs",
        variant: "destructive"
      })
    }
  }
